...
target_audience: VP/SVP Product or Partnerships at ABM, CRM/MAP, sales intelligence platforms
positioning_angle: First-party persona + intent topic intelligence as competitive moat for platforms
...
# Cold Outreach: Platform Data Partnerships

## Packaging Reminder
**Standard offering:** Personas + intent topics (which buyer personas are in-market for which topics).
**Full file (contacts + content consumed):** $1M+ enterprise partners only (SFDC, HubSpot scale). Cannibalizes lead gen.

## Subject Line Variants

1. "Your platform's intent intelligence layer"
...
## Email Body — Variant A (Control)

**Subject:** Persona-level intent intelligence for [Platform Name]

Hi [First Name],

pharosIQ generates 3-6M intent signals per month from our owned content ecosystem. First-party, persona-level, exclusive to each buyer. Not a co-op model.
...
## Email Body — Variant B (Proof-Led)

**Subject:** The intelligence layer AI can't replicate

Hi [First Name],

Data Infrastructure companies now trade at 24.4x EBITDA, nearly double the median SaaS multiple. The only software category expanding in valuation multiples right now is Analytics and Data Management.
...
## Email Body — Variant C (Contrarian)

**Subject:** Your intent data provider sells the same signals to your competitors

Hi [First Name],

If your platform uses co-op intent data, every one of your competitors sees the same signals you do. Same accounts surging. Same topics. Same timing.
...
Wanted to bump this. The short version: we have first-party intent data at the persona level (which buyer roles are in-market for which topics), and we're building out platform partnerships.

If now isn't the right time, no problem. Happy to reconnect when data partnerships are on the roadmap.
