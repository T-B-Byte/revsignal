    ...
    // ===== DECK 2: DaaS Power Phrases =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_detail: 'Most competitors (Bombora, G2) only do account-level. TechTarget does contact-level but locks it in their platform (32M contacts). We deliver 270M+ contacts as an open feed.',
          image_url: null,
        ...
        },
        {
          ...
          back_content: '270M+ total contacts, 650+ intent categories, 3-6M monthly signals (majority tied to a contact), 50M B2B inboxable, 17M email openers, 1.5M active engagers in 90-day window.',
          back_detail: null,
          image_url: null,
          source_attribution: 'Ben Luck Day 1 meeting',
        },
        ...
        },
        {
          ...
          back_content: 'TechTarget locks contact-level data inside Priority Engine (their own platform, 32M contacts). IRIS delivers as a raw data feed designed to be embedded into the buyer\'s own systems: API, flat file, cloud delivery, or OEM integration. 270M+ contacts.',
        ...
        },
        {
          ...
          back_content: 'Five layers, each hard to replicate alone, nearly impossible together: (1) 270M+ permission-based contacts built over years. (2) Owned engagement channels (newsletters, call centers, Vyde, direct mail, syndication) generating fresh signals weekly. (3) Six-factor scoring algorithm tuned on years of behavioral data. (4) Content-weighted signals (case studies, not "What-is" pages). (5) Contact-level resolution in a post-pandemic world where IP-based competitors lost accuracy.',
    ...
    // ===== DECK 3: Data Asset & Signals =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_detail: 'Privacy-forward model that works in a post-cookie world. Enterprise buyers (especially in regulated industries) increasingly require clean room matching. pharosIQ\'s 270M+ contacts become a matching asset, not just a delivery asset.',
          image_url: null,
          source_attribution: 'Monetization strategy (Marty Fettig call analysis)',
        },
        {
    ...
    // ===== DECK 6: Competitive Intel =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_content: 'TechTarget does offer contact-level data (Priority Engine, 32M contacts). But it\'s locked inside their platform. pharosIQ delivers 270M+ contacts as an open feed designed for embedding. Also: TechTarget\'s traffic is mostly "What-is" pages (generic, low-intent).',
          back_detail: 'Beat them on scale (270M vs 32M), delivery flexibility (open feed vs locked platform), and content quality (case studies vs What-is pages).',
          image_url: null,
