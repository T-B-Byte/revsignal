    ...
    // ===== DECK 2: DaaS Power Phrases =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_detail: 'Most competitors (Bombora, G2) only do account-level. TechTarget does contact-level but locks it in their platform (32M contacts). We deliver 125.3M contacts (last 90 days) as an open feed.',
          image_url: null,
        ...
        },
        {
          ...
          back_content: '125.3M (last 90 days) total contacts, 8,756 intent categories, 3-6M monthly signals (majority tied to a contact), 50M B2B inboxable, 17M email openers, 1.5M active engagers in 90-day window.',
          back_detail: null,
          image_url: null,
          source_attribution: 'Ben Luck Day 1 meeting',
        },
        ...
        },
        {
          ...
          back_content: 'TechTarget locks contact-level data inside Priority Engine (their own platform, 32M contacts). IRIS delivers as a raw data feed designed to be embedded into the buyer\'s own systems: API, flat file, cloud delivery, or OEM integration. 125.3M contacts (last 90 days).',
        ...
        },
        {
          ...
          back_content: 'Five layers, each hard to replicate alone, nearly impossible together: (1) 125.3M permission-based contacts (last 90 days) built over years. (2) Owned engagement channels (newsletters, call centers, Vyde, direct mail, syndication) generating fresh signals weekly. (3) Six-factor scoring algorithm tuned on years of behavioral data. (4) Content-weighted signals (case studies, not "What-is" pages). (5) Contact-level resolution in a post-pandemic world where IP-based competitors lost accuracy.',
    ...
    // ===== DECK 3: Data Asset & Signals =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_detail: 'Privacy-forward model that works in a post-cookie world. Enterprise buyers (especially in regulated industries) increasingly require clean room matching. pharosIQ\'s 125.3M contacts (last 90 days) become a matching asset, not just a delivery asset.',
          image_url: null,
          source_attribution: 'Monetization strategy (Marty Fettig call analysis)',
        },
        {
    ...
    // ===== DECK 6: Competitive Intel =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_content: 'TechTarget does offer contact-level data (Priority Engine, 32M contacts). But it\'s locked inside their platform. pharosIQ delivers 125.3M contacts (last 90 days) as an open feed designed for embedding. Also: TechTarget\'s traffic is mostly "What-is" pages (generic, low-intent).',
          back_detail: 'Beat them on scale (125.3M (last 90 days) vs 32M), delivery flexibility (open feed vs locked platform), and content quality (case studies vs What-is pages).',
          image_url: null,
    ...
    // ===== DECK 9: Objection Handling — Data Moats =====
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back_detail: '"Proprietary data compounds over time. The longer the product operates, the deeper the moat becomes." — Attainment Labs. pharosIQ has 125.3M contacts (last 90 days), 8,756 intent categories, and years of signal history. Building that from scratch is a multi-year, multi-million dollar project.',
          image_url: null,
          source_attribution: 'Attainment Labs',
        },
        {
          ...
          back_detail: 'Even a16z (the biggest data moat skeptic) says defensibility comes from "differentiated technology and domain expertise, with data a key fuel for both." pharosIQ has all three: contentree.com (tech), 20+ years in intent (expertise), 125.3M contacts (last 90 days) (data).',
          image_url: null,
