...
import { logConversation } from "@/app/(dashboard)/contacts/[contactId]/actions";
...
interface LogConversationForContactProps {
  contactId: string;
  deals?: DealOption[];
}
...
export function LogConversationForContact({
  contactId,
  deals,
}: LogConversationForContactProps) {
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="border border-border-primary rounded-md p-4 bg-surface-secondary/50 space-y-3">
            ...
            <p className="text-xs text-text-muted">
              Capture the next action to keep things moving forward.
            </p>
            <Input
              name="next_step"
              label="Next Step"
